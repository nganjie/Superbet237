              ...
              <div class="card mb-4">
                ...
                @endphp
                      ...
                      <td>{{ $evaluation->nomparc }}</td>
                        ...
                        <td>
                             <a href="#" class="btn btn-sm btn-primary attribnote" data-id="{{ $evaluation->id }}" data-idre="{{ $evaluation->idre }}" data-toggle="modal" data-target="#eeexampleModal" dataa-toggle="tooltip" data-original-title="Attribuer les notes" ><i class="fas fa-share"></i></a>
                             <a href="#" class="btn btn-sm btn-primary voirnote" data-id="{{ $evaluation->id }}" data-idre="{{ $evaluation->idre }}" data-toggle="modal" data-target="#eeeexampleModal" dataa-toggle="tooltip" data-original-title="Voir les notes" ><i class="fas fa-eye"></i></a>
      ...
      <input style="display:none;" type="text" class="form-control" name="iddperio" >
        ...
        <button type="submit" class="btn btn-danger confirmDelete" id="confirmDelete">Supprimer</button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="eeexampleModalLabel">Noter les auditeurs</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
...
<input type="text" style="display:none;" name="ideva" id="ideva">
                  ...
                  <div class="form-group">
                    ...
                    <select class="select-single-placeholder form-control" name="salle" >
                      <option disabled selected>choisir la salle</option>
                      @foreach($salles as $salle)
                      <option value="{{$salle->id}}">{{$salle->codeSalle}}--{{$salle->nom}}</option>
                      @endforeach
                    </select>
                  </div>
          ...
          <!-- Modale de confirmation de notation -->
<div class="modal fade" id="ddeleteModal" tabindex="-1" role="dialog" aria-labelledby="ddeleteModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ddeleteModalLabel">Confirmation d'attribution de la note</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Êtes-vous sûr de vouloir attribuer cette note à cet auditeur ?
      </div>
      <div class="modal-footer">
        <form action="{{ route('evaluation_note_Insert') }}" method="POST">
          @csrf
          <input type="text" class="form-control" name="idev">
          <input type="text" class="form-control" name="note">
          <input type="text" class="form-control" name="idaudi">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
          <button type="submit" class="btn btn-danger confirmDelete" id="confirmDelete">Attribuer</button>
        </form>
      </div>
    </div>
  </div>
